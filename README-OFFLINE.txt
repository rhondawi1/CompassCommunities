...
assets required (no CDNs, no fonts, no scripts from the web).

How to open:
1) Unzip this folder anywhere (e.g., Desktop).
2) Double-click `index.html`.
3) Navigate via the header/footer links. All pages and images are inside this folder.
...
- Some buttons intentionally link **out** to public websites (e.g., Nichols & Wood, JBLC Construction,
  ...
  you are online; otherwise they simply wont load (the local site still works).
- The Events page stores attachment links in your browsers localStorage so it works offline.
